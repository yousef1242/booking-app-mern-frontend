...
import "./ownerUpdateHotelDashboardRight.css";
import {
...
const OwnerDashboardUpdateHotelRight = () => {
  const navigate = useNavigate();
  const dispatch = useDispatch();
  const { hotelupdateId } = useParams();
  ...
  useEffect(() => {
    dispatch(setSingleHotelApiCall(hotelupdateId));
  }, [dispatch, hotelupdateId]);
  useEffect(() => {
    if (Singlehotels) {
      setTitle(Singlehotels.title);
      setCity(Singlehotels.city);
      setDescription(Singlehotels.description);
      setCountry(Singlehotels.country);
      setPrice(Singlehotels.price);
      setTaxes(Singlehotels.taxes);
      setDistance(Singlehotels.distance);
      setRooms(Singlehotels.rooms);
      setGusts(Singlehotels.maxGuests);
      setBed(Singlehotels.bed);
    }
  }, [Singlehotels]);
  ...
  const handleImagesSelection = (e) => {
    ...
    setSelectedImages([...selectedImages, uploadedImage]);
  };
  ...
  const formHandlerSubmit = (event) => {
    ...
    if (distance === "") return toast.error("Distance is required");
    ...
    setLoading(true);
    dispatch(setUpdateHotelApi(hotelupdateId, formData)).then((isOk) => {
    ...
    <>
      <div className="col-12 col-md-9 py-md-5 owner-dashboard-add-hotel">
        <div className="container">
          <h2 className="fw-bold mb-5">Update hotel</h2>
          <form onSubmit={formHandlerSubmit} className="row m-0 w-100">
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Wifi")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Kitchen")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "TV")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Pool")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Freezer")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Heating")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <div className="feature-checkbox col-12 col-md-4">
              <div
                className={`card ${
                  selectedFeatures?.find((feature) => feature === "Breakfast")
                    ? "selected"
                    : ""
                }`}
              >
            ...
            <button type="submit" className="d-flex align-content-center justify-content-center" disabled={loading && true}>
              {!loading ? (
                "Update hotel"
              ) : (
                <div class="loader">
...
export default OwnerDashboardUpdateHotelRight;
